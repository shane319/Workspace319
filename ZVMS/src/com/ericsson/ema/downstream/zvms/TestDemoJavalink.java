...
public class TestDemoJavalink
{
	...
	public static void main(String[] args) throws DownStreamException
    {
    	...
    	//String connTimeOut = "2000"; // String, but accept only digits
		//String soTimeOut = "2000";
    	
    	// used to detect if DemoJavalink is generated correctly
    	VmsJavalink testLink = new VmsJavalink();
        
        String[] configurations = new String[2];
        for (int i = 0; i < 2; ++i)
        {
            configurations[i] = "This is a tester.";
        }
        configurations[0] = "http://127.0.0.1:8085/WebSimulator/simulator.do";
        //configurations[0] = "http://10.67.26.188:8085/WebSimulator/simulator.do";
        
        configurations[1] = "2000";
