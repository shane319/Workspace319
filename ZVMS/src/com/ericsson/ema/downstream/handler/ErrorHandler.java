...
public class ErrorHandler {
	...
	public void handleError(HttpException e) throws JavaLinkException {
		handleCommonError(e);
		throw new JavaLinkException(e.getClass().getSimpleName(), 9028);
	}
	
	public void handleError(IOException e) throws JavaLinkException {
		handleCommonError(e);
		throw new JavaLinkException(e.getClass().getSimpleName(), 9029);
	}
