...
package com.ericsson.ema.downstream.mmscsub;
...
public class DemoJavalink implements DownStreamConnection
{
	...
	public DemoJavalink()
    {
        ...
        DOMConfigurator.configure("/var/sog/sdk/downstream/java/MMSC/log4j.xml");
    }

    /***************************************************************************
     * Set Configuration *
     **************************************************************************/
    public void setConfiguration(String[] configurations) throws DownStreamException
    {
    ...
    public String sendMessage(String mmlString) throws DownStreamException
    {
        ...
        //logger.debug("receive:" + mmlString);
        
        
        ProvisioningController provisioningController = new ProvisioningController(configurations,mmlString);
       ...
       /* Long end_time = System.currentTimeMillis();
		...
		logger.debug("response:" + responseBean.getResponse());*/
